...
function LoginPage() {
  ...
  //Executado quando há alteração no estado do usuário (persistir o login ao atualizar a página)
  ...
  //Sempre que houver uma modificação nos campos "userCredentials" e "setUserCredentials"
  function handleCredentials(e) {
    setUserCredentials({ ...userCredentials, [e.target.name]: e.target.value });
  }

  //Utilizada para criar uma nova conta
