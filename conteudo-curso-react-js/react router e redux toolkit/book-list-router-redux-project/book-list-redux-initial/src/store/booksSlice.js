...
export const booksSlice = createSlice({
  ...
  reducers: {
    ...
    eraseBook: (books, action) => {
      //Lógica para apagar livros
      return books.filter(book => book.id != action.payload);
    },
    toogleRead: (books, action) => {
      books.map(book => {
...
//Exportando todas as funções criadas acima
export const { addBook, eraseBook, toogleRead } = booksSlice.actions;

//Criando uma nova variável para selecionar os livros, relaciona o que tá criado no store
